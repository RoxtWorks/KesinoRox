...
// logic itself â€” see Assets/Scripts/Core for that.
public class GameManager : MonoBehaviour
{
    ...
    // list to write out â€” trackers each keep their own capped/derived view of this
    // same data.
    ...
    // P/L (bottom) â€” stacked and sized to fill the column instead of leaving most
    ...
    void Start()
    {
        ...
        // â€” the wheel/belt animations freeze on whatever frame they were mid-lerp on
    ...
    void SetupCamera()
    {
        ...
        // automatically â€” that only happens through the Editor's "Create > Camera"
    ...
    void SetupLight()
    {
        ...
        // black shadow face â€” cheap two-light setup instead of flat single directional.
    ...
    void SetupUI()
    {
        ...
        // Without this, the canvas renders at a fixed pixel size â€” on any screen
        ...
        // Application.Quit() is a no-op in the Editor â€” without it this button would
        ...
        rulesPanel.Build(canvasGO.transform, "ROULETTE RULES",
            ...
            "STRAIGHT UP (single number) â€” pays 35:1\n" +
            "SPLIT (2 adjacent numbers) â€” pays 17:1\n" +
            "STREET (3 numbers, one row) â€” pays 11:1\n" +
            "CORNER (4 numbers) â€” pays 8:1\n" +
            "LINE (6 numbers, two rows) â€” pays 5:1\n" +
            "DOZEN / COLUMN (12 numbers) â€” pays 2:1\n" +
            "RED/BLACK, ODD/EVEN, 1-18/19-36 â€” pays 1:1\n\n" +
        ...
        // Starts near the HUD's own text line (inside the panel, not above it) â€” the
        ...
        hud.Build(canvasGO.transform, bankroll,
            addAmount =>
            {
                ...
                // AddFunds (not Deposit) so this counts as new money in, not winnings â€”
            ...
            resetAmount =>
            {
                // Recap before wiping anything â€” a session disappearing into RESET
                ...
                // Full reset: bankroll back to the stated amount, every tracker wiped â€”
        ...
        // status line â€” a straight scrolling strip of pockets in real wheel order,
        ...
        // Restore last session, if a save exists â€” bankroll first, then feed every
        ...
        // were. Used to call each tracker's AddRecord/AddSpin once per saved spin â€”
    ...
    // immediately) â€” catches anything else that might end the process.
